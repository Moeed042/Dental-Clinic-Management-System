...
-- Seed Initial Admin User (Default Username: admin, Email: admin@dentalclinic.com, Password: admin123)
-- Password hash generated with bcrypt (10 salt rounds) for 'admin123'
